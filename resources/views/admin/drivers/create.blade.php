...
@section('page-title', 'Tambah Sopir Baru')

@section('content')
    <div class="card" style="max-width:600px;">
        <div class="card-header">
            <h3><i class="fas fa-user-plus" style="color:var(--primary);margin-right:8px;"></i> Form Tambah Sopir</h3>
            ...
            <form method="POST" action="{{ route('admin.drivers.store') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror"
                           value="{{ old('name') }}" placeholder="Nama sopir" required>
                ...
                <div style="display:grid;grid-template-columns:1fr 1fr;gap:0 20px;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="employee_id" name="employee_id" class="form-control @error('employee_id') is-invalid @enderror"
                               value="{{ old('employee_id') }}" placeholder="DRV001">
